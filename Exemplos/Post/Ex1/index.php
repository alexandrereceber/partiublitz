...
<html>
    <head>
        ...
        <script  src="../../../Scripts/jsControlador/jsConstroller.js?f443ss3" defer="defer"></script>     
        <script  src="../../../Componentes/posts.js?s=1dsswssss" defer="defer"></script>  
        <script  src="index.js?q=53w5sdasdwasdw" defer="defer"></script>  
