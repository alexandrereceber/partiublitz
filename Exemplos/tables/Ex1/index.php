...
echo '<script>var Chave = ""</script>'
...
<html>
    <head>
        ...
        <script  src="../../../Componentes/Tabelas.js?q=367s35as7s" defer="defer"></script>  
        <script  src="index.js?q=sasd" defer="defer"></script>  
