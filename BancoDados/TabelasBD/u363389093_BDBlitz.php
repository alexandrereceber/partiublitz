    ...
    private $Campos =  [
            ...
            [
               ...
               "Formulario"     => [
                                        ...
                                        "TypeConteudo"=> ["Membros","Administrador","Gerente","Produtor"], 
                                        "Name" => "TUSER",
            ...
            case "InserirDadosTabela":
                ...
                switch ($Action) {
                    ...
                    case "BeforeInsert":
                        ...
                        $ConjuntoDados[3]["value"] = 1;
                        
                        $ConjuntoDados[5]["name"] = "PLogin";
                        $ConjuntoDados[5]["value"] = $this->UsuarioLogin;
            ...
            if($PERF["Eventos"] === false){
                ...
                if(!$PERF["Aniversario"]){
                    ...
                    if($PERF["Listas_Eventos"] === false){
                        ...
                        if(!$PERF["Lista_no_Nivel"]){
                            
                        }else{
                            $PERF["Lista_no_Nivel"]["text"] = "Lista R$ " . $PERF["Lista_no_Nivel"]["Valor"];

                        }
                    }
                    //-----------------------------------------
                }else{
                    $PERF["Aniversario"]["text"] = "FREE";
                }
...
class user_aniver_semana extends ModeloTabelas{
    /**
     * Mapeia os campos da tabela - Muito importante caso se queira visualizar somente campo necessários
     */
    private $Campos =  [
    ...
    private $Privilegios = [["Membros","Select"]];
    private $TipoPaginacao = ["Simples"=>false, "SaltoPagina"=> true, "Filtros"=>true, "BRefresh"=>true];
